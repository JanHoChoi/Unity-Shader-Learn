Shader "Unity Shaders Book/Chapter 13/Edge Detect Normal And Depth"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        half CheckSame(half4 center, half4 sample)  // 返回0表示有边界, 返回1表示没有
        {
            half2 centerNormal = center.xy;  // normal不需要解码,只需要知道差异值多少即可
